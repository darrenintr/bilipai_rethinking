...
/// --------------------------------------
/// The legacy `Logger` (in `BiliPaiNativeApp.swift`) holds raw `bpLog`
...
/// `Application Support/BiliPai/log.jsonl`.  Each line is a JSON
...
final class DiagnosticLogger: ObservableObject {
    ...
    private let diskQueue = DispatchQueue(
        label: "BiliPai.diaglog.disk", qos: .utility
    )
