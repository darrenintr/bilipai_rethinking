    ...
    final class Coordinator {
        ...
        func attachPiP(
            ...
            guard let controller = InlinePiPController(
                ...
                // `.paladalaPiPPossibleChanged` notification.
...
final class InlinePiPController: NSObject, AVPictureInPictureControllerDelegate {
    ...
    func pictureInPictureControllerWillStartPictureInPicture(
        ...
        NotificationCenter.default.post(
            name: .paladalaPiPWillStart, object: nil
        )
    }
    ...
    func pictureInPictureControllerDidStartPictureInPicture(
        ...
        NotificationCenter.default.post(
            name: .paladalaPiPDidStart, object: nil
        )
    }
    ...
    func pictureInPictureControllerWillStopPictureInPicture(
        ...
        NotificationCenter.default.post(
            name: .paladalaPiPWillStop, object: nil
        )
    }
    ...
    func pictureInPictureControllerDidStopPictureInPicture(
        ...
        NotificationCenter.default.post(
            name: .paladalaPiPDidStop, object: nil
        )
    }
...
extension Notification.Name {
    ...
    /// player state object.
    static let paladalaPiPWillStart = Notification.Name("paladala.pip.willStart")
    static let paladalaPiPDidStart = Notification.Name("paladala.pip.didStart")
    static let paladalaPiPWillStop = Notification.Name("paladala.pip.willStop")
    static let paladalaPiPDidStop = Notification.Name("paladala.pip.didStop")
...
final class InlinePiPHolder: ObservableObject {
    ...
    /// on every `paladalaPiPPossibleChanged` notification.
    ...
    func refreshPiPPossible() {
        ...
        isPiPPossible = new
        NotificationCenter.default.post(
            name: .paladalaPiPPossibleChanged, object: nil
        )
    }
